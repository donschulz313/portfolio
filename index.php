...
<title>Don Schulz portfolio</title>
		...
		<div class="deebo_fn__cv">
			...
			<div class="cv__header">
				<div class="in">
					...
					<h3><span>Don</span> Schulz</h3>
					<p class="quote">  I am a Graphic Designer.  With over 7 years of experience in the graphic design industry, photo editing, including 3 years of experience in UI/UX designer. I’m available for a freelance job. <a href="#contact" class="anchor">Hire me</a></p>
					<ul class="contact_info">
						<li>
							<span class="icon"><img src="svg/location.svg" alt="" class="fn__svg"></span>
							<p>Otto Braun Strabe Berlin German</p>
						</li>
						<li>
						...
						<li>
							...
							<p>starbrave333@gmail.com.com</p>
						</li>
					</ul>
					<!-- <ul class="social">
						<li>
			...
			<div class="cv__content">
					...
					<div class="content">
						<div class="left_hero_header">
							<div class="circle">
								...
								<img src="img/thumb/Me-2.jpg" alt="" />
				...
				<section id="cv_biography">
					...
					<p>I'm a Freelancer Senior Graphic Designer with over 7 years of experience. I'm from Berlin. I can design web, UI/UX and edit photos for amazing people around the world. I like work with new people. New people are new experiences.</p>
					<div class="fn_cs_info_items">
						<ul>
							<li><p>Name: <span>Don Schulz</span></p></li>
							<li><p>Birthday: <span>March 13, 1993</span></p></li>
							<li><p>Languages: <span>English, Germany</span></p></li>
							<li><p>Age: <span>30 Years</span></p></li>
							<li><p>Nationality: <span>German</span></p></li>
							<li><p>Adress: <span>Berlin, German</span></p></li>
							<li><p>Telegram: <span>https://t.me/DonSchulz0313</span></p></li>
							<li><p>Phone: <span><a href="tel:+17785355344">(+1) 509 523 4289</a></span></p></li>
							<li><p>Skype: <span>live:.cid.e108bcb63ec0903c</span></p></li>
							<li><p>Email: <span><a href="mailto:flabteam@gmail.com">starbrave333@gmail.com</a></span></p></li>
						</ul>
					</div>
				</section>
				<!-- /CV: Biography Section -->
					...
					<div class="fn_cs_boxed_list">
						<ul>							
							<li>
								<div class="item">
									<div class="item_top">
										<h5>Pforzheim University</h5>
										<span>( 2012 — 2016 )</span>
									</div>
									<h3>Master Degree</h3>
									<p> Master of Arts in Graphic design </p>
								</div>
							</li>
							<li>
								<div class="item">
									<div class="item_top">
										<h5>Stanford Graduate school of education </h5>
										<span>( 2007 — 2011 )</span>
									</div>
					...
					<div class="fn_cs_boxed_list">
						<ul>
							<li>
								<div class="item">
									<div class="item_top">
										<h5>Great Design Agency</h5>
										<span>( 2019 — 2023 )</span>
									</div>
									<h3>Senior Graphic Designer</h3>
									<p>-established and manage a freelance graphic design business to assist companies in brand development.<br>
-conceptualized visual identity, including brand positioning, promotions, and digital marketing for different companies,<br>
-conceptualized logo designs, gif animations, videos, websites and social media channels to promote product brands
</p>
								</div>
							</li>
							<li>
								<div class="item">
									...
									<p>- Create designs, concepts, and sample layouts, based on knowledge of layout and esthetic design concepts. <br>- Prepared illustrations and rough sketches of materials,  discussed them with clients, and made necessary changes. <br>- Developed graphics and layouts for product illustrations, logos, and websites mirroring company brand style.  </p>
								</div>
							</li>
							<li>
								<div class="item">
									<div class="item_top">
										<h5>Great Media Group</h5>
										<span>( 2016 — 2017 )</span>
									</div>
									<h3>Junior Graphic Designer</h3>
									<p>-Utilized After Effect and other Computer proficiency making motion graphic animations for video production. <br>-coordinate with the client to create prolific social media  graphics for target marketing.  </p>
								</div>
							</li>
						</ul>
					</div>
				...
				<section id="cv_skills">
					...
					<div class="fn_cs_progress_bar">
						...
						<div class="progress_item" data-value="85">
							<div class="item_in">
								<h3 class="progress_title">Adobe Indesign</h3>
								<span class="progress_percent"></span>
								<div class="progress_bg"></div>
							</div>
						</div>
				...
				<section id="cv_services">
					...
					<p>I help ambitious businesses like yours generate more profits by building awareness, driving web traffic, connecting with customers and growing overall sales.<br>
					And Make your life become more happy and beautiful with high skills and much experiences</p>
					...
					<div class="fn_cs_portfolio">
						...
						<div class="portfolio_filter">
							<ul>
								...
								<li><a href="#" data-filter=".youtube">Lasson</a></li>
								<li><a href="#" data-filter=".vimeo">OmniVus</a></li>
								<li><a href="#" data-filter=".soundcloud">DIVERGE AI</a></li>
									...
									<div class="inner">
										<div class="entry">
											<a class="popup-youtube" href="https://www.youtube.com/watch?v=7e90gBu4pas">
												<img src="img/thumb/42-34.jpg" height="500px;">
